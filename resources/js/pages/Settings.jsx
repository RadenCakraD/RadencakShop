...
export default function Settings() {
        ...
        try {
            ...
            if (res.data && res.data.features && res.data.features.length > 0) {
                ...
                if (fallbackRes.data && fallbackRes.data.length > 0) {
                    ...
                    toast.error('Lokasi tidak ditemukan. Coba ketik nama jalan utama atau kota.');
                }
            }
        } catch (e) {
            console.error("Gagal mencari lokasi", e);
            toast.error('Gagal mencari lokasi, pastikan Anda terhubung ke internet.');
        } finally {
    ...
    const handleSetPrimary = async (id) => {
        ...
        } catch(e) { toast.error("Gagal menjadikan utama"); }
    };

    return (
        <div className="bg-rc-bg min-h-screen text-rc-main font-sans pb-24 overflow-x-hidden relative font-light">
            ...
            <nav className="sticky top-0 z-50 bg-rc-bg/75 backdrop-blur-xl border-b border-rc-main/10 shadow-sm transition-all duration-300">
                <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
                    <motion.button 
                        onClick={() => navigate(-1)} 
                        whileTap={{ scale: 0.95 }}
                        className="group flex items-center gap-3 text-xs font-bold uppercase text-rc-muted transition-colors duration-300"
                    >
                    ...
                    <div className="flex items-center gap-3 bg-rc-card/50 px-4 py-1.5 rounded-full border border-rc-main/15">
                        <i className="fa-solid fa-sliders text-rc-logo animate-pulse"></i>
                        <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-rc-muted">Pusat Pengaturan</span>
                    </div>
                </div>
            </nav>
                        ...
                        <div className="w-full">
                            ...
                            {activeTab === 'informasi_akun' && user && (
                                <div className="space-y-6">
                                    <div className="bg-rc-card border border-rc-main/15 rounded-[2rem] p-6 md:p-10 shadow-xl relative overflow-hidden">
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-rc-logo/5 rounded-full blur-2xl"></div>
                                        <h3 className="text-xl font-black uppercase text-rc-main mb-1.5 relative z-10">Profil & Identitas</h3>
                                        ...
                                        <form onSubmit={handleUpdateAccount} className="relative z-10">
                                            <div className="flex flex-col md:flex-row gap-10 items-start">
                                                ...
                                                <div className="flex flex-col items-center gap-4 shrink-0 mx-auto md:mx-0">
                                                    <div className="w-28 h-28 rounded-[2rem] bg-rc-bg border border-rc-main/15 overflow-hidden flex items-center justify-center relative cursor-pointer shadow-inner">
                                                ...
                                                <div className="flex-1 w-full space-y-8">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div className="space-y-2.5">
                                                            ...
                                                            <input type="text" value={accountFormData.name} onChange={e => setAccountFormData({ ...accountFormData, name: e.target.value })} placeholder="Masukkan nama asli Anda" className="w-full bg-rc-bg border border-rc-main/15 text-rc-main text-xs font-bold p-4 rounded-2xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                                        </div>
                                                        <div className="space-y-2.5">
                                                            <label className="text-[10px] font-black text-rc-muted uppercase tracking-widest flex items-center gap-2">
                                                                <i className="fa-solid fa-envelope text-pink-500"></i> Alamat Email
                                                            </label>
                                                            <input type="email" value={accountFormData.email} onChange={e => setAccountFormData({ ...accountFormData, email: e.target.value })} placeholder="email@contoh.com" className="w-full bg-rc-bg border border-rc-main/15 text-rc-main text-xs font-bold p-4 rounded-2xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div className="space-y-2.5">
                                                            ...
                                                            <input type="tel" value={accountFormData.no_hp} onChange={e => setAccountFormData({ ...accountFormData, no_hp: e.target.value })} placeholder="Cth: 081234..." className="w-full bg-rc-bg border border-rc-main/15 text-rc-main text-xs font-bold p-4 rounded-2xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                                        </div>
                                                        <div className="space-y-2.5">
                                                            <label className="text-[10px] font-black text-rc-muted uppercase tracking-widest flex items-center gap-2">
                                                                <i className="fa-solid fa-user-tag text-purple-500"></i> Username ID
                                                            </label>
                                                            <div className="w-full bg-rc-main/5 border border-rc-main/10 text-rc-muted text-xs font-bold p-4 rounded-2xl cursor-not-allowed opacity-60">
                                                                @{user?.username}
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div className="h-[1px] w-full bg-rc-main/10"></div>
                                                    ...
                                                    <div className="space-y-6">
                                                        ...
                                                        <div className="bg-rc-bg/50 p-6 rounded-2xl border border-rc-main/15 flex items-center justify-between">
                                                            ...
                                                            <button 
                                                                ...
                                                                className={`w-14 h-7 rounded-full relative transition-colors duration-300 shrink-0 ${user?.two_factor_enabled ? 'bg-rc-logo' : 'bg-rc-main/10'}`}
                                                            >
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            <input type="password" value={accountFormData.password} onChange={e => setAccountFormData({ ...accountFormData, password: e.target.value })} placeholder="Kata Sandi Baru" className="w-full bg-rc-bg border border-rc-main/15 text-rc-main text-xs font-bold p-4 rounded-2xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                                            <input type="password" value={accountFormData.password_confirmation} onChange={e => setAccountFormData({ ...accountFormData, password_confirmation: e.target.value })} placeholder="Ulangi Sandi Baru" className="w-full bg-rc-bg border border-rc-main/15 text-rc-main text-xs font-bold p-4 rounded-2xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                                        </div>
                                                    </div>

                                                    <button type="submit" disabled={updatingAccount} className="bg-rc-logo text-rc-bg text-[10px] font-black uppercase tracking-[0.2em] px-10 py-5 rounded-2xl transition-all disabled:opacity-50 w-full md:w-fit">
                                ...
                                <div className="space-y-6">
                                    <div className="bg-rc-card border border-rc-main/15 rounded-[2rem] p-6 md:p-10 shadow-xl relative overflow-hidden">
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 relative z-10 gap-4">
                                            <div>
                                                <h3 className="text-xl font-black uppercase text-rc-main mb-1">Buku Alamat</h3>
                                            ...
                                            }} className="bg-rc-logo text-rc-bg text-xs font-bold uppercase tracking-widest px-6 py-3 rounded-full transition-all">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                                            {addresses.length === 0 ? (
                                                <div onClick={() => { 
                                                    ...
                                                    setStreetDetail(''); setSelectedProv(''); setSelectedReg(''); setSelectedDist('');
                                                    setMapPosition(null); setShowModal(true); 
                                                }} className="col-span-full py-16 border-2 border-dashed border-rc-main/20 rounded-xl flex flex-col items-center justify-center text-center cursor-pointer hover:border-rc-logo transition group">
                                                    <i className="fa-solid fa-map-location-dot text-4xl text-rc-muted mb-4 opacity-50 transition"></i>
                                                ...
                                                <div key={addr.id} className={`p-6 rounded-[1.5rem] border ${addr.is_primary ? 'border-rc-logo bg-rc-logo/5' : 'border-rc-main/15 bg-rc-bg/50'} relative`}>
                                                    ...
                                                    <p className="text-xs text-rc-muted font-medium mb-1.5">{addr.full_address}</p>
                                                    ...
                                                    <div className="mt-5 flex gap-2">
                                                        {!addr.is_primary ? (
                                                            <button onClick={() => handleSetPrimary(addr.id)} className="text-[10px] uppercase font-bold text-rc-logo border border-rc-logo/30 px-3 py-1.5 rounded transition">Pilih Utama</button>
                                                        ) : null}
                                                        <button onClick={() => { 
                                                            setFormData(addr); 
                                                        ...
                                                        }} className="text-[10px] uppercase font-bold text-rc-muted px-3 py-1.5 border border-rc-main/10 rounded transition">Edit</button>
                                                        <button onClick={() => handleDelete(addr.id)} className="text-[10px] uppercase font-bold text-red-500 px-3 py-1.5 border border-red-500/20 rounded transition">Hapus</button>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                            ...
                            {activeTab === 'bahasa' && (
                                <div className="space-y-6">
                                    <div className="bg-rc-card border border-rc-main/15 rounded-[2rem] p-6 md:p-10 shadow-xl relative overflow-hidden">
                                        ...
                                        <h3 className="text-xl font-black uppercase text-rc-main mb-2 relative z-10">Bahasa Antarmuka</h3>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10 w-full md:w-2/3">
                                            <label className="flex items-center gap-4 p-5 border border-rc-logo bg-rc-logo/5 rounded-xl cursor-pointer">
                                            ...
                                            <label className="flex items-center gap-4 p-5 border border-rc-main/10 bg-rc-bg rounded-xl cursor-not-allowed opacity-50 relative overflow-hidden">
                            ...
                            {activeTab === 'bantuan_cs' && (
                                <div className="space-y-6">
                                    <div className="bg-rc-card border border-rc-main/15 rounded-[2rem] p-6 md:p-10 shadow-xl relative overflow-hidden">
                                        ...
                                        <h3 className="text-xl font-black uppercase text-rc-main mb-2 relative z-10">Halo Radencak! (Call Center)</h3>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                                            <a href="https://wa.me/6285230886080" target="_blank" className="p-8 border border-green-500/20 bg-green-500/5 rounded-2xl flex flex-col md:flex-row items-center gap-6">
                                                <div className="w-16 h-16 rounded-full bg-green-500 flex items-center justify-center shadow-lg shadow-green-500/20 shrink-0">
                                            ...
                                            <a href="mailto:radencakstudio@gmail.com" className="p-8 border border-blue-500/20 bg-blue-500/5 rounded-2xl flex flex-col md:flex-row items-center gap-6">
                                                <div className="w-16 h-16 rounded-full bg-blue-500 flex items-center justify-center shadow-lg shadow-blue-500/20 shrink-0">
                            ...
                            {activeTab === 'pengaduan' && (
                                <div className="space-y-6">
                                    <div className="bg-rc-card border border-red-500/20 rounded-[2rem] p-6 md:p-10 shadow-xl relative overflow-hidden">
                                        <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/5 rounded-full blur-2xl"></div>
                                        <h3 className="text-xl font-black uppercase text-rc-main mb-2 relative z-10 flex items-center gap-2">
                                        ...
                                        <form onSubmit={handleSubmitComplaint} className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                                            <div className="col-span-full md:col-span-1">
                                                ...
                                                <select required value={complaintForm.subject} onChange={e => setComplaintForm({...complaintForm, subject: e.target.value})} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-red-500 transition focus:bg-red-500/5">
                                            ...
                                            <div className="col-span-full">
                                                ...
                                                <textarea required value={complaintForm.message} onChange={e => setComplaintForm({...complaintForm, message: e.target.value})} rows="4" placeholder="Ceritakan kronologi secara rinci..." className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-red-500 transition focus:bg-red-500/5 resize-none"></textarea>
                                            </div>
                                            <div className="col-span-full">
                                                <button type="submit" disabled={submittingComplaint} className="w-full md:w-auto bg-red-600 text-white text-xs font-bold uppercase tracking-widest px-8 py-3.5 rounded-xl transition-colors disabled:opacity-50">
                                                    {submittingComplaint ? 'Mengirim...' : 'Kirim Laporan Resmi'}
                                                </button>
                                            </div>
                                        </form>

                                        <h4 className="text-sm font-bold text-rc-main uppercase border-b border-rc-main/10 pb-3 mb-4"><i className="fa-solid fa-clock-rotate-left mr-2"></i> Riwayat Pengaduan Anda</h4>
                                        <div className="space-y-4">
                                            {complaints.length === 0 ? (
                                                <div className="text-center py-6 text-xs text-rc-muted uppercase font-bold tracking-widest">Belum ada laporan pengaduan.</div>
                                            ) : (
                                                complaints.map(c => (
                                                    <div key={c.id} className="p-5 border border-rc-main/10 bg-rc-bg/50 rounded-xl relative">
                            ...
                            {activeTab === 'kemitraan' && (
                                <div className="space-y-10">
                                    ...
                                    {user?.role === 'admin_kurir' && (
                                        <div className="bg-rc-card p-6 md:p-8 border border-rc-main/15 rounded-[2rem] shadow-xl relative overflow-hidden">
                                            <div className="flex justify-between items-center mb-6">
                                                <div>
                                                    <h3 className="text-xl font-black uppercase text-rc-main mb-1 flex items-center gap-2">
                                                ...
                                                {user?.status === 'pending' ? (
                                                    <div className="bg-yellow-500/10 text-yellow-500 px-4 py-2 rounded-lg border border-yellow-500/30 text-[10px] font-black uppercase tracking-wider">Sedang Ditinjau</div>
                                                ) : (
                                                    <div className="bg-blue-500/10 text-blue-500 px-4 py-2 rounded-lg border border-blue-500/30 text-[10px] font-black uppercase">Aktif</div>
                                                )}
                                            </div>
                                            
                                            {user?.status === 'pending' ? (
                                                <div className="bg-rc-bg/50 p-8 rounded-xl border border-yellow-500/20 text-center space-y-3">
                                                ...
                                                <>
                                                    <div className="bg-rc-bg/50 p-6 rounded-xl border border-rc-main/10 mb-6">
                                                        ...
                                                        <form onSubmit={(e) => handleInviteStaff(e, 'kurir_staff')} className="flex gap-2 max-w-lg">
                                                            <input 
                                                                ...
                                                                className="flex-1 bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-blue-500 transition"
                                                            />
                                                            <button type="submit" className="bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest px-6 py-3 rounded-xl transition-all">Undang</button>
                                                        </form>
                                                    </div>
                                        ...
                                        <div className="bg-rc-card p-6 md:p-8 border border-rc-main/15 rounded-[2rem] shadow-xl relative overflow-hidden">
                                            <div className="flex justify-between items-center mb-6">
                                                ...
                                                {user?.status === 'pending' ? (
                                                    ...
                                                    <div className="bg-orange-500/10 text-orange-500 px-4 py-2 rounded-lg border border-orange-500/30 text-[10px] font-black uppercase">Aktif</div>
                                                )}
                                            </div>
                                                    ...
                                                    <div className="bg-rc-bg/50 p-6 rounded-xl border border-rc-main/10 mb-6">
                                                        ...
                                                        <form onSubmit={(e) => handleInviteStaff(e, 'logistik_staff')} className="flex gap-2 max-w-lg">
                                                            <input 
                                                                ...
                                                                value={inviteEmail}
                                                                onChange={e => setInviteEmail(e.target.value)}
                                                                className="flex-1 bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-orange-500 transition"
                                                            />
                                                            <button type="submit" className="bg-orange-600 text-white text-[10px] font-black uppercase tracking-widest px-6 py-3 rounded-xl transition-all">Undang</button>
                                                        </form>
                                                    </div>
                                    ...
                                    {user?.shop && (
                                        <div className="bg-rc-card p-6 md:p-8 border border-rc-main/15 rounded-[2rem] shadow-xl relative overflow-hidden">
                                            <div className="flex justify-between items-center mb-6">
                                                ...
                                                <Link to="/toko" className="bg-rc-logo text-rc-bg px-4 py-2 rounded-lg text-[10px] font-black uppercase shadow-lg shadow-rc-logo/20 transition-all">Buka Dashboard Toko</Link>
                                            </div>
                                            ...
                                            <div className="bg-rc-bg/50 p-6 rounded-xl border border-rc-main/10 mb-6">
                                                ...
                                                <form onSubmit={handleInviteStaff} className="flex gap-2 max-w-lg">
                                                    <input 
                                                        ...
                                                        value={inviteEmail}
                                                        onChange={e => setInviteEmail(e.target.value)}
                                                        className="flex-1 bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition"
                                                    />
                                                    <button type="submit" className="bg-rc-logo text-rc-bg text-[10px] font-black uppercase tracking-widest px-6 py-3 rounded-xl transition-all">Undang</button>
                                                </form>
                                            </div>
                                    ...
                                    {invitations.length > 0 && (
                                        <div className="bg-gradient-to-r from-rc-logo/20 to-transparent p-6 md:p-8 border border-rc-logo/30 rounded-[2rem] shadow-xl mb-8">
                                            <h3 className="text-xl font-black uppercase text-rc-main mb-4 flex items-center gap-2">
                                                <i className="fa-solid fa-envelope-open-text text-rc-logo"></i> Undangan Bergabung
                                            </h3>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {invitations.map(inv => (
                                                    <div key={inv.id} className="bg-rc-bg p-5 rounded-xl border border-rc-main/10 flex items-center justify-between">
                                                        <div>
                                                        ...
                                                        <div className="flex gap-2">
                                                            <button 
                                                                ...
                                                                className="bg-rc-logo text-rc-bg text-[10px] font-black uppercase px-4 py-2 rounded-lg transition"
                                                            >
                                                                Terima
                                                            </button>
                                                            <button 
                                                                ...
                                                                className="bg-rc-main/10 text-rc-muted text-[10px] font-black uppercase px-4 py-2 rounded-lg transition"
                                                            >
                                                                Tolak
                                                            </button>
                                                        </div>
                                    ...
                                    {user?.status === 'pending' && (
                                        <div className="bg-rc-card border border-yellow-500/30 p-10 rounded-[2rem] shadow-xl relative overflow-hidden mb-8">
                                            ...
                                            <div className="flex flex-col items-center text-center py-6">
                                                ...
                                                <h3 className="text-xl font-black uppercase text-rc-main mb-2">Pendaftaran Sedang Ditinjau</h3>
                                    ...
                                    {(user?.status !== 'pending' && user?.mitra_type === 'none' && !['admin_kurir', 'admin_logistik', 'kurir_staff', 'logistik_staff', 'super_admin', 'admin_staff'].includes(user?.role)) && (
                                        <div className="space-y-8">
                                            <div className="bg-rc-card border border-rc-main/15 p-6 md:p-10 rounded-[2rem] shadow-xl relative overflow-hidden">
                                                <div className="absolute top-0 right-0 w-32 h-32 bg-rc-logo/5 rounded-full blur-2xl"></div>
                                                <h3 className="text-xl font-black uppercase text-rc-main mb-2 relative z-10">Lamar Menjadi Mitra</h3>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                                                    {!user?.shop && (
                                                        <Link to="/daftar-toko" className="p-6 border border-rc-main/10 bg-rc-bg/50 rounded-2xl flex flex-col items-center text-center group">
                                                            <i className="fa-solid fa-shop text-3xl mb-4 text-rc-logo"></i>
                                                    ...
                                                    <button onClick={() => setMitraRegType('admin_kurir')} className="p-6 border border-rc-main/10 bg-rc-bg/50 rounded-2xl flex flex-col items-center text-center group">
                                                        <i className="fa-solid fa-truck-fast text-3xl mb-4 text-blue-500"></i>
                                                    ...
                                                    <button onClick={() => setMitraRegType('admin_logistik')} className="p-6 border border-rc-main/10 bg-rc-bg/50 rounded-2xl flex flex-col items-center text-center group">
                                                        <i className="fa-solid fa-warehouse text-3xl mb-4 text-orange-500"></i>
                                            ...
                                            <div className="bg-rc-card border border-rc-main/15 p-6 md:p-10 rounded-[2rem] shadow-xl">
                                                <h3 className="text-xl font-black uppercase text-rc-main mb-6">Lamar Sebagai Staff</h3>
                                                <form onSubmit={handleStaffApply} className="space-y-6 max-w-lg">
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <select 
                                                                ...
                                                                className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition"
                                                            >
                                                    ...
                                                    {staffRegData.parent_id && (
                                                        <div className="bg-rc-logo/5 border border-rc-logo/20 p-4 rounded-xl space-y-2.5">
                                    ...
                                    {mitraRegType && (
                                        <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 backdrop-blur-md p-4">
                                            <div className="bg-rc-bg border border-rc-main/20 p-8 rounded-2xl w-full max-w-md shadow-2xl relative">
                                                ...
                                                <form onSubmit={handleMitraRegister} className="space-y-4">
                                                    <div>
                                                        ...
                                                        <input required type="text" value={mitraRegData.name} onChange={e => setMitraRegData({...mitraRegData, name: e.target.value})} placeholder="Misal: JNE Cabang Bandung" className="w-full bg-rc-card border border-rc-main/10 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo" />
                                                    </div>
                                                    <div>
                                                        <label className="text-[9px] font-black text-rc-muted uppercase tracking-[0.2em] mb-1.5 block">Negara Operasional</label>
                                                        <select required value={mitraRegData.region_id} onChange={e => setMitraRegData({...mitraRegData, region_id: e.target.value, coverage_province: '', coverage_regency: '', coverage_district: ''})} className="w-full bg-rc-card border border-rc-main/10 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo">
                                                    ...
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <div className="bg-rc-logo/5 border border-rc-logo/30 p-3 rounded-xl space-y-3">
                                                                <div>
                                                                    <label className="text-[9px] font-bold text-rc-logo uppercase tracking-widest mb-1 block">Provinsi Operasional *</label>
                                                                    <select required value={mitraRegData.coverage_province} onChange={e => setMitraRegData({...mitraRegData, coverage_province: e.target.value, coverage_regency: '', coverage_district: ''})} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo">
                                                                ...
                                                                {mitraRegType === 'admin_kurir' && mitraRegData.coverage_province && (
                                                                    <>
                                                                        <div>
                                                                            ...
                                                                            <select required value={mitraRegData.coverage_regency} onChange={e => setMitraRegData({...mitraRegData, coverage_regency: e.target.value, coverage_district: ''})} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo">
                                                                        ...
                                                                        {mitraRegData.coverage_regency && (
                                                                            <div>
                                                                                ...
                                                                                <select required value={mitraRegData.coverage_district} onChange={e => setMitraRegData({...mitraRegData, coverage_district: e.target.value})} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input required type="tel" value={mitraRegData.no_hp} onChange={e => setMitraRegData({...mitraRegData, no_hp: e.target.value})} placeholder="08..." className="w-full bg-rc-card border border-rc-main/10 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo" />
                                                    </div>
            ...
            {showModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md p-2 sm:p-4">
                    <div className="bg-rc-bg border border-rc-main/20 rounded-2xl w-full max-w-5xl overflow-hidden shadow-2xl relative flex flex-col max-h-[95vh]">
                        <div className="bg-rc-card p-4 sm:p-5 border-b border-rc-main/10 flex justify-between items-center flex-shrink-0">
                            <h2 className="text-sm md:text-base font-black uppercase tracking-widest text-rc-main flex items-center gap-2">
                                <i className="fa-solid fa-map-pin text-rc-logo"></i> {formData.id ? 'Edit Radar Alamat' : 'Radar Alamat Baru'}
                            </h2>
                            ...
                            <form onSubmit={handleSaveAddress} className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
                                ...
                                <div className="flex flex-col h-full">
                                    <label className="text-[10px] font-bold text-rc-muted uppercase mb-1.5 flex items-center gap-2 tracking-widest">
                                        <i className="fa-solid fa-map-pin text-rc-logo"></i> Titik Lokasi Peta (GPS)
                                    ...
                                    <div className="flex gap-2 mb-2">
                                        <input 
                                            ...
                                            className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo transition focus:bg-rc-logo/5"
                                        />
                                    ...
                                    <div className="w-full h-64 md:h-96 lg:h-[450px] lg:flex-grow rounded-2xl overflow-hidden border border-rc-logo/30 relative shadow-inner">
                                        ...
                                        <div className="absolute bottom-2 left-2 right-2 z-10 flex justify-center pointer-events-none">
                                            <div className="bg-black/80 backdrop-blur-md px-4 py-2 rounded-full border border-white/20 text-[10px] uppercase font-bold text-white tracking-widest pointer-events-auto text-center">
                                ...
                                {/* KANAN: FORMULIR */}
                                <div className="space-y-5 lg:pl-4 lg:border-l border-rc-main/10 flex flex-col justify-center">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="text-[10px] font-bold text-rc-muted uppercase mb-1.5 block tracking-widest">Label Alamat (Tag)</label>
                                            <input type="text" value={formData.tag} onChange={e => setFormData({...formData, tag: e.target.value})} placeholder="Rumah, Kantor, dll" required className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                        </div>
                                        <div>
                                            <label className="text-[10px] font-bold text-rc-muted uppercase mb-1.5 block tracking-widest">Nomor HP Penerima</label>
                                            <input type="tel" value={formData.phone_number} onChange={e => setFormData({...formData, phone_number: e.target.value})} placeholder="Mis. 0812..." required className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        }} required className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5">
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border border-rc-logo/30 bg-rc-logo/5 p-4 rounded-xl">
                                                <div>
                                                    <label className="text-[9px] font-bold text-rc-logo uppercase mb-1.5 block tracking-widest">Provinsi</label>
                                                    <select value={selectedProv} onChange={e => { setSelectedProv(e.target.value); setSelectedReg(''); setSelectedDist(''); }} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo">
                                                        <option value="">Pilih Provinsi</option>
                                                        {allProvinces.map(p => <option key={p.id} value={p.name}>{p.name}</option>)}
                                                    </select>
                                                </div>
                                                {selectedProv && (
                                                    <div>
                                                        ...
                                                        <select value={selectedReg} onChange={e => { setSelectedReg(e.target.value); setSelectedDist(''); }} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo">
                                                            <option value="">Pilih Kab/Kota</option>
                                                            {provObj?.regencies?.map(r => <option key={r.id} value={r.name}>{r.name}</option>)}
                                                        </select>
                                                    </div>
                                                ...
                                                {selectedReg && (
                                                    <div>
                                                        ...
                                                        <select value={selectedDist} onChange={e => setSelectedDist(e.target.value)} className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-2.5 rounded-lg outline-none focus:border-rc-logo">
                                                            <option value="">Pilih Kecamatan</option>
                                                            {regObj?.districts?.map(d => <option key={d.id} value={d.name}>{d.name}</option>)}
                                                        </select>
                                                    </div>
                                    ...
                                    <div>
                                        <label className="text-[10px] font-bold text-rc-muted uppercase mb-1.5 block tracking-widest">Nama Penerima</label>
                                        <input type="text" value={formData.receiver_name} onChange={e => setFormData({...formData, receiver_name: e.target.value})} placeholder="Nama orang yang menerimakan paket" required className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea value={streetDetail} onChange={e => setStreetDetail(e.target.value)} required placeholder="Jalan, RT/RW, Dusun..." rows="3" className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5 resize-none"></textarea>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" value={formData.note} onChange={e => setFormData({...formData, note: e.target.value})} placeholder="Cth: Rumah pagar hitam, depan masjid besar" className="w-full bg-rc-bg border border-rc-main/20 text-rc-main text-xs font-bold p-3 rounded-xl outline-none focus:border-rc-logo transition focus:bg-rc-logo/5" />
                                    </div>

                                    <button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-black uppercase tracking-widest text-xs lg:text-sm py-4 lg:py-5 rounded-xl transition-all mt-8">
